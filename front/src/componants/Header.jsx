        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {typeof user !== "undefined" && user ? (
            <div className="flex items-center gap-4 ">
              ...
              <button
                onClick={logout}
                className="ml-2 bg-linear-to-r from-yellow-400 to-orange-500 px-4 py-1.5 rounded-full
               font-medium text-white hover:shadow-lg hover:shadow-yellow-300 transition-all"
              >
                Logout
              </button>
            </div>
